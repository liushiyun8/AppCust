...
import foundation.load.indicators.BallSpinFadeLoaderIndicator;
...
public class AVLoadingIndicatorView extends View {
    ...
    private foundation.widget.load.Indicator mIndicator;
    ...
    public foundation.widget.load.Indicator getIndicator() {
        return mIndicator;
    }

    public void setIndicator(foundation.widget.load.Indicator d) {
        if (mIndicator != d) {
            if (mIndicator != null) {
    ...
    public void setIndicator(String indicatorName){
        ...
        try {
            ...
            foundation.widget.load.Indicator indicator = (Indicator) drawableClass.newInstance();
