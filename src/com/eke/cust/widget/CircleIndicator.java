...
public class CircleIndicator extends LinearLayout {
    ...
    private int mIndicatorBackgroundResId = R.drawable.shape_yellow_round;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.shape_whie_round_bg;
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.anim.scale_with_alpha, 0, R.drawable.point_white, R.drawable.point_white);
    }
    ...
    private final OnPageChangeListener mInternalPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (circlePageChangeListener != null) {
                circlePageChangeListener.changePage(position);
            }
    ...
    /**
     * @ User  OnCirclePageChangeListener
     */
    public void addOnPageChangeListener(OnCirclePageChangeListener circlePageChangeListener) {
