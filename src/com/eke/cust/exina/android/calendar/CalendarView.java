...
package com.eke.cust.exina.android.calendar;
...
public class CalendarView extends ImageView {
    ...
    public Drawable mDecoration = null;
    public Drawable mDecoraClick = null;
    private Context context;
    private boolean mIsCustomDate = false;
	...
	public void initCalendarDate(int year, int month, int day) {
		mRightNow = Calendar.getInstance();
		...
		try {
			mRightNow = Calendar.getInstance();
			mRightNow.setTime(sdf.parse(strDate));
