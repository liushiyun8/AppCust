package com.eke.cust.pay.wechat;
 ...
 */
public class WXPay {
    public static  String  PARTNERID="1354612202";
    ...
    public void doPay(String pay_param, WXPayResultCallBack callback) {
        ...
        ToastUtils.show(AppContext.getInstance(),"正在启动支付,请稍后!");
        mWXApi.sendReq(req);
    }
    ...
    public void onResp(int error_code) {
        ...
        MyLog.d("WXPay","error_code"+error_code);
        if(error_code == 0) {   //成功
            mCallback.onSuccess();
