...
import com.eke.cust.chat.adapter.MineConversationAdapater;
...
public class MineConversationList extends ListViewForScrollView {
    ...
    protected MineConversationAdapater adapter;
    protected List<EMConversation> conversations = new ArrayList<EMConversation>();


    public MineConversationList(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MineConversationList(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void init(List<EMConversation> conversationList, EaseConversationListHelper helper){
        ...
        if(conversationList==null||conversations.size()<5){
            for (int  i=0;i<5;i++){
                conversationList.add(null);
            }
        }
        adapter = new MineConversationAdapater(context, 0, conversationList);
