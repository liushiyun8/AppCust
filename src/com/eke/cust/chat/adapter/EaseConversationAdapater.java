...
public class EaseConversationAdapater extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (holder == null) {
            ...
            holder.allCount = (TextView) convertView.findViewById(R.id.all_msg_number);
        ...
        if (conversation.getUnreadMsgCount() > 0) {
            ...
            holder.unreadLabel.setTextColor(ContextCompat.getColor(getContext(),R.color.red));
            holder.unreadLabel.setText(String.valueOf(conversation.getUnreadMsgCount()));
            holder.unreadLabel.setVisibility(View.VISIBLE);
        } else {
//            holder.unreadLabel.setVisibility(View.INVISIBLE);
            holder.unreadLabel.setTextColor(ContextCompat.getColor(getContext(),R.color.black));
            holder.unreadLabel.setText(""+0);

        }
        holder.allCount.setText("/"+String.valueOf(conversation.getAllMsgCount()));
