...
public class InviteMessgeDao {
	...
	public void updateMessage(int msgId,ContentValues values){
	    CustDBManager.getInstance().updateMessage(msgId, values);
	}
	

	public void deleteMessage(String from){
	    CustDBManager.getInstance().deleteMessage(from);
	}
	
	public int getUnreadMessagesCount(){
	    return CustDBManager.getInstance().getUnreadNotifyCount();
	}
	
	public void saveUnreadMessageCount(int count){
	    CustDBManager.getInstance().setUnreadNotifyCount(count);
	}
}
