...
package com.eke.cust.davemorrissey.labs.subscaleview;
...
import com.eke.cust.R.styleable;
import com.eke.cust.davemorrissey.labs.subscaleview.decoder.CompatDecoderFactory;
import com.eke.cust.davemorrissey.labs.subscaleview.decoder.DecoderFactory;
import com.eke.cust.davemorrissey.labs.subscaleview.decoder.ImageDecoder;
import com.eke.cust.davemorrissey.labs.subscaleview.decoder.ImageRegionDecoder;
import com.eke.cust.davemorrissey.labs.subscaleview.decoder.SkiaImageDecoder;
import com.eke.cust.davemorrissey.labs.subscaleview.decoder.SkiaImageRegionDecoder;
...
public class SubsamplingScaleImageView extends View {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (maxTouchCount > 0) {
				if (touchCount >= 2) {
					...
					// One finger zoom
					// Stole Google's Magical Formula鈩�to make sure it feels the
					// exact same
	 ...
	 *         {@link SubsamplingScaleImageView.AnimationBuilder#start()} to
	 *         start the anim.
	 */
