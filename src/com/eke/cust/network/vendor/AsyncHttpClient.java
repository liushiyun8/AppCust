...
package com.eke.cust.network.vendor;
...
public class AsyncHttpClient {
    ...
    /**
     * Sets the maximum number of retries and timeout for a particular
     *
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle get(Context context, String url, HttpEntity entity,Header[] headers, String contentType, ResponseHandlerInterface responseHandler) {
    	//AppContext.isWifi = NetWorkUtils.checkNetworkState(context);
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpGet(URI.create(url).normalize()), entity, headers), contentType, responseHandler, context);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle post(String url, Header[] headers,ResponseHandlerInterface responseHandler) {
        return post(null, url, null, headers,responseHandler);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle post(String url, RequestParams params,Header[] headers, ResponseHandlerInterface responseHandler) {
        return post(null, url, params,headers, responseHandler);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle post(Context context, String url, RequestParams params,Header[] headers, ResponseHandlerInterface responseHandler) {
        return post(context, url, paramsToEntity(params, responseHandler),headers, null, responseHandler);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle post(Context context, String url, HttpEntity entity, Header[] headers,String contentType, ResponseHandlerInterface responseHandler) {
    	//AppContext.isWifi = NetWorkUtils.checkNetworkState(context);
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPost(getURI(url)), entity, headers), contentType, responseHandler, context);
    }
    ...
    public RequestHandle post(Context context, String url, Header[] headers, HttpEntity entity, String contentType,
                              ResponseHandlerInterface responseHandler) {
    	//AppContext.isWifi = NetWorkUtils.checkNetworkState(context);
        HttpEntityEnclosingRequestBase request = addEntityToRequestBase(new HttpPost(getURI(url)), entity, headers);
        if (headers != null) request.setHeaders(headers);
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle put(String url, Header[] headers,ResponseHandlerInterface responseHandler) {
        return put(null, url, null, headers,responseHandler);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle put(String url, RequestParams params,Header[] headers ,ResponseHandlerInterface responseHandler) {
        return put(null, url, params, headers, responseHandler);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle put(Context context, String url, RequestParams params,Header[] headers, ResponseHandlerInterface responseHandler) {
        return put(context, url, paramsToEntity(params, responseHandler),headers, null, responseHandler);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle put(Context context, String url, HttpEntity entity, Header[] headers, String contentType, ResponseHandlerInterface responseHandler) {
    	//AppContext.isWifi = NetWorkUtils.checkNetworkState(context);
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPut(getURI(url)), entity, headers), contentType, responseHandler, context);
    }
    ...
    public RequestHandle put(Context context, String url, Header[] headers, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
        HttpEntityEnclosingRequestBase request = addEntityToRequestBase(new HttpPut(getURI(url)), entity, headers);
       // AppContext.isWifi = NetWorkUtils.checkNetworkState(context);
        if (headers != null) request.setHeaders(headers);
        return sendRequest(httpClient, httpContext, request, contentType, responseHandler, context);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle patch(String url, Header[] headers, ResponseHandlerInterface responseHandler) {
        return patch(null, url, null, headers, responseHandler);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle patch(String url, RequestParams params,Header[] headers, ResponseHandlerInterface responseHandler) {
        return patch(null, url, params,headers, responseHandler);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle patch(Context context, String url, RequestParams params,Header[] headers,  ResponseHandlerInterface responseHandler) {
        return patch(context, url, paramsToEntity(params, responseHandler), headers, null, responseHandler);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle patch(Context context, String url, HttpEntity entity, Header[] headers, String contentType, ResponseHandlerInterface responseHandler) {
    	//AppContext.isWifi = NetWorkUtils.checkNetworkState(context);
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPatch(getURI(url)), entity, headers), contentType, responseHandler, context);
    }
    ...
    public RequestHandle patch(Context context, String url, Header[] headers, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
    	//AppContext.isWifi = NetWorkUtils.checkNetworkState(context);
        HttpEntityEnclosingRequestBase request = addEntityToRequestBase(new HttpPatch(getURI(url)), entity, headers);
        if (headers != null) request.setHeaders(headers);
        return sendRequest(httpClient, httpContext, request, contentType, responseHandler, context);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle delete(Context context, String url, HttpEntity entity, Header[] headers, String contentType, ResponseHandlerInterface responseHandler) {
    	//AppContext.isWifi = NetWorkUtils.checkNetworkState(context);
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpDelete(URI.create(url).normalize()), entity, headers), contentType, responseHandler, context);
    }
...
//            }
     ...
     */
    private HttpEntityEnclosingRequestBase addEntityToRequestBase(HttpEntityEnclosingRequestBase requestBase, HttpEntity entity, Header[] headers) {
        if (entity != null) {
