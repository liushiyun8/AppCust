...
public interface ErrorHandler {
  /**
   * Return a custom exception to be thrown for a {@link HttpError}. It is recommended that you
   ...
   * </pre>
   *
   * @param cause the original {@link HttpError} exception
   ...
   */
  Throwable handleError(HttpError cause);

  /** An {@link ErrorHandler} which returns the original error. */
  ErrorHandler DEFAULT = new ErrorHandler() {
    @Override public Throwable handleError(HttpError cause) {
      return cause;
    }
  };
}
