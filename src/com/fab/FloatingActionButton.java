...
public class FloatingActionButton extends ImageButton {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		// int size = getDimension(mType == TYPE_NORMAL ?
...
//		mShadowSize = getDimension(R.dimen.fab_shadow_size);
	...
	private Drawable createDrawable(int color) {
		...
		// if (mShadow && !hasLollipopApi()) {
		// Drawable shadowDrawable = getResources().getDrawable(mType ==
		// TYPE_NORMAL ? R.drawable.fab_shadow
		// : R.drawable.fab_shadow_mini);
		// LayerDrawable layerDrawable = new LayerDrawable(new
		// Drawable[]{shadowDrawable, shapeDrawable});
		// layerDrawable.setLayerInset(1, mShadowSize, mShadowSize, mShadowSize,
		// mShadowSize);
